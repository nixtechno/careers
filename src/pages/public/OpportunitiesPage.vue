<template>
  <PublicLayout>
    ...
    <section class="bg-white py-16">
      <div v-if="filteredOpportunities.length > 0" class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
          <article v-for="opportunity in paginatedOpportunities" :key="opportunity.slug" class="rounded-lg border border-slate-200 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:border-emerald-200 hover:shadow-xl">
